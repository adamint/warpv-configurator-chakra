...
export function GeneralSettingsForm({ generalSettings, setGeneralSettings, formErrors }) {
  return <Box>
    <FormControl isRequired={true} isInvalid={formErrors.includes('isa')} mb={4}>
    ...
    <FormControl isRequired={true} isInvalid={formErrors.includes('depth')} mb={5}>
    ...
    {generalSettings.isa === 'RISC-V' && <FormControl>
